  ...
  return (
    <>
      <div className="project-wrapper">
        ...
        <p className="p2">This is our latest newsletter.</p>
        <p className="p2">
          To view all our previous newsletters, go to our
          <a>newsletters, go to our </a>
        </p>
            ...
            {activeTab === "latest" ? (
              ...
              <div className="blog-list">
                ...
                <div className="blog-item">
                  ...
                  />
                  <p className="blog-title">
                    AevumJagat Movie Director Dinesh Narra Exclusive
                    Interview_SP Interview
                  </p>
                </div>
                <div className="blog-item">
                  <img
        ...
        <p className="p1">Previous News</p>
