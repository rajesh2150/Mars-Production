        ...
        <div className="partners-section">
          ...
          <div className="partners-list">
            <div className="partner">
              <img className="partner-logo" src={Partner1} alt="Calle Vapor" />
              <p className="partner-name">Calle Vapor</p>
              <p className="partner-description">
                Calle Vapor es un conjunto de música afrolatina, que surge en
                Córdoba capital en el 2006, interpre
              </p>
            </div>
            <div className="partner">
              <img
              ...
              <p className="partner-description">
                Imagination, Artistic approach, Creative intent, Skill and
                Personal Touch
              </p>
            </div>
